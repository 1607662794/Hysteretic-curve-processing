...
# 原图
ax.plot(df['times(s)'], df['degraded strength(KN)']/53.02, label='源数据', color=(58/255, 9/255, 100/255))
...
# 筛选后的图
ax.scatter(filtered_df['times(s)'], filtered_df['degraded strength(KN)']/53.02, label='采样数据', color=(58/255, 9/255, 100/255),s=30, marker='v',zorder=2)
...
ax.set_ylabel('强度退化比率', font={'family': 'SimSun', 'size': 22})
...
plt.savefig(f'E:\\研究生\\科研生活\\横向课题\\4.12-4.26冯老师教材\\绘图\\python绘图\\strength抽样图.png', dpi=600, bbox_inches='tight')
