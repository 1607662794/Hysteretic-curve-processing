...
# 原图
ax.plot(df['times(s)'], df['degraded stiff(KN/mm)'] / 61.27174006657513, label='Source data',color=(58/255, 9/255, 100/255))
...
ax.scatter(filtered_df['times(s)'], filtered_df['degraded stiff(KN/mm)'] / 61.27174006657513, label='Filter data',  color=(58/255, 9/255, 100/255),s=30, marker='v',zorder=2)
...
plt.savefig(f'E:\Code\Image regression\论文绘图\python绘图保存\stiff抽样图.png', dpi=600, bbox_inches='tight')
